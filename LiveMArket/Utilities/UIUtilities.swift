...
public class UIUtilities {
  ...
  public static func addCircle(
    ...
    circleView.alpha = Constants_scanner.circleViewAlpha
  ...
  public static func addRectangle(_ rectangle: CGRect, to view: UIView, color: UIColor) {
    ...
    rectangleView.layer.cornerRadius = Constants_scanner.rectangleViewCornerRadius
    rectangleView.alpha = Constants_scanner.rectangleViewAlpha
  ...
  public static func addShape(withPoints points: [NSValue]?, to view: UIView, color: UIColor) {
    ...
    shapeView.alpha = Constants_scanner.shapeViewAlpha
  ...
  public static func createUIImage(
    ...
    return UIImage(cgImage: cgImage, scale: Constants_scanner.originalScale, orientation: orientation)
  }
