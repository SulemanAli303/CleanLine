...
-(void)updateDefaultSettings:(CGSize)videoSize{
    self.videoSettings = @
    {
    AVVideoCodecKey: AVVideoCodecTypeH264,
        AVVideoWidthKey: [NSNumber numberWithFloat:videoSize.width*2],
        AVVideoHeightKey: [NSNumber numberWithFloat:videoSize.height*2],
