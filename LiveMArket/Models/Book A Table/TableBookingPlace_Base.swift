...
struct TableBookingPlace_Base : Codable {
    let status : String?
    let message : String?
    let oData : TableBookingPlaceData?
    ...
    init(from decoder: Decoder) throws {
        ...
        oData = try values.decodeIfPresent(TableBookingPlaceData.self, forKey: .oData)
    }

}
struct TableBookingPlaceData : Codable {
    let id : String?
