//
//  CompleteBookingCollectionDataSource.swift
//  LiveMArket
//
...
class CompleteBookingCollectionDataSource: NSObject {
    ...
    static let shared = CompleteBookingCollectionDataSource()

}

extension CompleteBookingCollectionDataSource: UICollectionViewDataSource,UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout{
