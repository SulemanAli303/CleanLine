...
class ChaletsNewBooking: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        viewControllerTitle = "New Bookings"
        setData()
        self.myOrdesListAPI()
...
extension ChaletsNewBooking : UITableViewDelegate ,UITableViewDataSource{
    func numberOfSections(in tableView: UITableView) -> Int {
        return 1
    }
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        guard myOrdersList.count != 0 else {
            tableView.setEmptyView(title: "", message: "You have no booking request", image: UIImage(named: "undraw_personal_file_re_5joy 1"))
