//
//  AddServicePayCollectionDataSource.swift
//  LiveMArket
//
...
class AddServicePayCollectionDataSource: NSObject {
    ...
    static let shared = AddServicePayCollectionDataSource()

}

extension AddServicePayCollectionDataSource: UICollectionViewDataSource,UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout{
