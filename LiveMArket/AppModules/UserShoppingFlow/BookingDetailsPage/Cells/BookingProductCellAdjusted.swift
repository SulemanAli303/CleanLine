//
//  BookingProductCellAdjusted.swift
//  LiveMArket
//
//  Created by Adnan Sohail on 27/03/2024.
//
...
class BookingProductCellAdjusted: UITableViewCell {
    ...
    func setdate() {
        ...
        //self.stock.text = "\(productList?.stockQuantity ?? "") Quantity"
