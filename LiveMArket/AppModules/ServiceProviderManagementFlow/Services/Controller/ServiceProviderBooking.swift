...
class ServiceProviderBooking: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        viewControllerTitle = "Skill Providers"
    ...
    @IBAction func menuPressed(_ sender: UIButton) {
        ...
        Coordinator.goToActiveSubscription(controller: self)
...
extension ServiceProviderBooking: UICollectionViewDataSource,UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.productImage.image = UIImage(named: "serviceprovider")
            return cell
    }
