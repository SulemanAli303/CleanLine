...
class SellerOrderDetailViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        viewControllerTitle = "Stuffed Zucchini".localiz()
    ...
    func setProductCell() {
        ...
        productCollection.register(UINib.init(nibName: "SellerOrderDetailAddToCart", bundle: nil), forCellWithReuseIdentifier: "SellerOrderDetailAddToCart")
...
extension SellerOrderDetailViewController: UICollectionViewDataSource , UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "SellerOrderDetailAddToCart", for: indexPath) as? SellerOrderDetailAddToCart else
...
extension SellerOrderDetailViewController: UICollectionViewDelegateFlowLayout {
