...
import UIKit
 ...
 class TableViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource, TableCellDelegate, TableViewDataChangedprotocol{
    ...
    open override func viewWillAppear(_ animated: Bool) {
        ...
        type = .backWithTop
        viewControllerTitle = "Select Date & Time"
        model.delegate = self
        if #available(iOS 13, *){
